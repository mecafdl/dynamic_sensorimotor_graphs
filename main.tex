...
\myhl{Let's analyze in details how the factors and their score can be used a behavioral descriptors.
Total score
For each 100 ms observation window, we get a \emph{main factor} corresponding to the factor with the highest contribution in the link density (Fig.~\ref{fig:factors_time}). These factors are colored by their apparent connection to a modality.}
% ---
\begin{figure*}[h!]
    \centering
