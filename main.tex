...
\author{Valentin Marcel, Fernando D\íaz Ledezma, Matej Hoffmann}
...
Advancements in the study of the brain's structural and \ac{fc} have deepened our understanding of its organization and information-processing capabilities. Adopting a similar approach to analyze the sensorimotor signals of an embodied agent could yield valuable insights into how the agent integrates and processes information through its behavior, with the goal of enabling adaptation. While investigating the structural connectivity of sensorimotor signals may not be directly applicable, examining their functional connectivity offers a viable path to understanding an agent's body structure and the emergence of behaviors through information acquisition.

In this context, a central concept is that of \ac{smc} \cite{Jacquey2019Sensorimotorcontingenciesas}, which represent consistent patterns that link an agent's sensorimotor signals to its embodiment. These \ac{smc} patterns can be identified and analyzed using information-theoretic methods. \myhl{This work specifically focuses on exploring the time-varying functional connectivity within an embodied agent's sensorimotor system, employing concepts from information theory and graph theory to gain deeper insights.}
% ---
\begin{figure}[!ht]
	\centering
